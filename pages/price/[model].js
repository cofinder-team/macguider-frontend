...
const Price = ({ model, year, ram, ssd }) => {
  let modelData
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="flex-grow md:px-3">
            <h1 className="text-xl font-bold leading-9 tracking-tight text-gray-900 dark:text-gray-100 sm:leading-10 md:text-2xl">
              Apple {year + ' ' + modelTitle} ({ram + ', ' + 'SSD ' + ssd})
            </h1>
            ...
            <ul className="mt-6 flex w-full max-w-xl  flex-wrap items-center rounded-lg border border-gray-200 bg-white text-sm font-medium text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
